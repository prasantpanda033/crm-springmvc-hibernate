...
<body>
    <div id="addForm">
        ...
        <form:form class="form-container" action="/CRM-SpringMVC-And-Hibernate/customer/save" method="POST" modelAttribute="customer">
            <form:hidden path="id"/>
            ...
            <a class="ms-5" href="/CRM-SpringMVC-And-Hibernate/customer/list">Back to list</a>
        </form:form>
    </div>
</body>
</html>
